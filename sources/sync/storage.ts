...
interface StorageState {
    ...
    updateSessionPermissionMode: (sessionId: string, mode: 'default' | 'acceptEdits' | 'bypassPermissions' | 'plan' | 'read-only' | 'safe-yolo' | 'yolo' | 'auto_edit') => void;
    updateSessionModelMode: (sessionId: string, mode: 'default' | 'adaptiveUsage' | 'sonnet' | 'opus' | 'gpt-5-minimal' | 'gpt-5-low' | 'gpt-5-medium' | 'gpt-5-high' | 'gpt-5-codex-low' | 'gpt-5-codex-medium' | 'gpt-5-codex-high' | 'gemini-2.0-flash' | 'gemini-2.0-flash-thinking' | 'gemini-2.0-pro') => void;
    // Artifact methods
...
export const storage = create<StorageState>()((set, get) => {
    ...
    return {
        ...
        updateSessionPermissionMode: (sessionId: string, mode: 'default' | 'acceptEdits' | 'bypassPermissions' | 'plan' | 'read-only' | 'safe-yolo' | 'yolo' | 'auto_edit') => set((state) => {
            const session = state.sessions[sessionId];
            if (!session) return state;
        ...
        updateSessionModelMode: (sessionId: string, mode: 'default' | 'adaptiveUsage' | 'sonnet' | 'opus' | 'gpt-5-minimal' | 'gpt-5-low' | 'gpt-5-medium' | 'gpt-5-high' | 'gpt-5-codex-low' | 'gpt-5-codex-medium' | 'gpt-5-codex-high' | 'gemini-2.0-flash' | 'gemini-2.0-flash-thinking' | 'gemini-2.0-pro') => set((state) => {
            const session = state.sessions[sessionId];
            if (!session) return state;
