...
export interface Session {
    ...
    permissionMode?: 'default' | 'acceptEdits' | 'bypassPermissions' | 'plan' | 'read-only' | 'safe-yolo' | 'yolo' | 'auto_edit' | null; // Local permission mode, not synced to server
    modelMode?: 'default' | 'adaptiveUsage' | 'sonnet' | 'opus' | 'gpt-5-minimal' | 'gpt-5-low' | 'gpt-5-medium' | 'gpt-5-high' | 'gpt-5-codex-low' | 'gpt-5-codex-medium' | 'gpt-5-codex-high' | 'gemini-2.0-flash' | 'gemini-2.0-flash-thinking' | 'gemini-2.0-pro' | null; // Local model mode, not synced to server
